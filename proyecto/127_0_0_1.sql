...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-03-2015 a las 02:35:01
...
(12, 'Douglass', 'Futuro', '1995-06-21', 'Que les inporta yo soy mio', 129414);
...
`id` int(11) NOT NULL,
  ...
  `escuela` enum('Sis','Manto') NOT NULL
